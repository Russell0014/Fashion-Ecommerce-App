            ...
            <div class="col-12 col-md-3 col-lg-2 text-center" style="min-width: 120px;">
                ...
                <div class="card-body">
                    <div class="form-check align">
                        <a href="thread" class="my-2 mx-auto sortButton">Recent</a>
                    </div>
                    <div class="form-check">
                        <a href="thread?sort=liked" class="my-2 mx-auto sortButton">Most Liked</a>
                    </div>
                    <h3>Search:</h3>
                    ...
                    <div class="card mb-2">
                        ...
                        <div class="card-body p-2 p-sm-3">
                            <div class="media forum-item">
                                ...
                                <a href="threadOpen?id=<?php echo $row['threadID']; ?>" style="text-decoration:none;">
